...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ДанныеЗаполнения <> Неопределено И ДанныеЗаполнения.Свойство("ВидДвижения") Тогда
		
		Сумма			 = ДанныеЗаполнения.Сумма;
		СуммаНазначения = ДанныеЗаполнения.Сумма;
		Валюта			= ДанныеЗаполнения.Валюта;
		ВалютаНазначения = ДанныеЗаполнения.Валюта;
		Курс 			= ДанныеЗаполнения.Курс;
		Кратность 		= ДанныеЗаполнения.Кратность;
		Комментарий 	= ДанныеЗаполнения.Комментарий;
		
		Если ДанныеЗаполнения.ВидДвижения = ПредопределенноеЗначение("Перечисление.ВидДвиженияДС.Доход") Тогда
			
			СчетНазначения 	= ДанныеЗаполнения.Счет;
			ТранзакцияПрихода = ДанныеЗаполнения.Транзакция;
			
		ИначеЕсли ДанныеЗаполнения.ВидДвижения = ПредопределенноеЗначение("Перечисление.ВидДвиженияДС.Расход") Тогда 
			
			Счет 	= ДанныеЗаполнения.Счет;
			ТранзакцияРасхода = ДанныеЗаполнения.Транзакция;
...
Процедура ПриКопировании(ОбъектКопирования)
	...
	ДокументКомиссии = Неопределено;
	ПланируемаяПокупка = Неопределено;
	ТранзакцияПрихода = Неопределено;
	ТранзакцияРасхода = Неопределено;
...
Процедура ОбработкаУдаленияПроведения(Отказ)
	...
	Если ЗначениеЗаполнено(ДокументКомиссии) И ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДокументКомиссии, "Проведен") Тогда
