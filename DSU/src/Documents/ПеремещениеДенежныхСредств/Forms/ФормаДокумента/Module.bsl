...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Объект.ДокументКомиссии) Тогда
		НаличиеКомиссии = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.ДокументКомиссии, "Проведен");
	...
	Если Параметры.Ключ.Пустая() И Параметры.Свойство("ДанныеЗаполнения") Тогда
		ЗаполнитьДаннымиНового(Параметры.ДанныеЗаполнения);
	КонецЕсли;	
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если ОписаниеОповещенияОЗакрытии <> Неопределено
        И ОписаниеОповещенияОЗакрытии.ДополнительныеПараметры.Свойство("ДанныеСтроки") Тогда

        ОписаниеОповещенияОЗакрытии.ДополнительныеПараметры.ДанныеСтроки.Документ = Объект.Ссылка;
        ОписаниеОповещенияОЗакрытии.ДополнительныеПараметры.ДанныеСтроки.Комментарий = Объект.Комментарий;
...
&НаСервере
Процедура ЗаполнитьДаннымиНового(ДанныеЗаполнения)
