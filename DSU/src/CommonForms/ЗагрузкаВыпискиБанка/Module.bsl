...
Функция НомерМесяцаПоПредставлениюСбербанка(ПредставлениеДня)
	...
	НомераДней.Вставить("января", 1);
	НомераДней.Вставить("февраля", 2);
	НомераДней.Вставить("марта", 3);
	НомераДней.Вставить("апреля", 4);
	НомераДней.Вставить("мая", 5);
	НомераДней.Вставить("июня", 6);
	НомераДней.Вставить("июля", 7);
	НомераДней.Вставить("августа", 8);
	НомераДней.Вставить("сентября", 9);
	НомераДней.Вставить("октября", 10);
	НомераДней.Вставить("ноября", 11);
	НомераДней.Вставить("декабря", 12);
