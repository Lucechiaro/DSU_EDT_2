...
Процедура ДобавитьСтрокуТранзакцииТинькофф(МассивПоказателей)
	...
	Дата = ДатаИзФорматаТинькофф(МассивПоказателей[0]);
	...
	СтрокаТранзакции.СуммаВВалютеСчета 	= Модуль(СуммаВВалютеСчета);
...
Функция ДатаИзФорматаТинькофф(Знач ДатаСтрокой)
