...
Процедура СформироватьОтчет() Экспорт
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДанных(ПараметрыДанных, "ДатаОтчета", Отчет.ДатаОтчета);
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДанных(ПараметрыДанных, "СтатьяДДС", Отчет.СтатьяДДС);
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДанных(ПараметрыДанных, "КоличествоМесяцев", Отчет.КоличествоМесяцев);
