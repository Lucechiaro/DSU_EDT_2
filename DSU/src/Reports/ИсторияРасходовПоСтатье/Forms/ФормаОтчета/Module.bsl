...
Функция СформироватьОтчетСКД() Экспорт 
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДанных(ПараметрыДанных, "НачалоПериода", НачалоПериода);
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДанных(ПараметрыДанных, "КонецПериода", КонецПериода);
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДанных(ПараметрыДанных, "СтатьяДДС", СтатьяДДС);
