...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ОбъектБД = ДанныеФормыВЗначение(Объект, Тип("ДокументОбъект.ПеремещениеДенежныхСредств"));
...
Процедура СуммаПриИзменении(Элемент)
	...
	//Если ЗначениеЗаполнено(Объект.Курс) И ЗначениеЗаполнено(Объект.Кратность) Тогда
	//	Если Объект.ИнвертироватьКурс Тогда
	//		Объект.СуммаНазначения = Объект.Сумма / Объект.Курс * Объект.Кратность;
	//	Иначе
	//		Объект.СуммаНазначения = Объект.Сумма * Объект.Курс / Объект.Кратность;
	//	КонецЕсли;	
	//КонецЕсли;	
...
&НаКлиенте
Процедура СуммаНазначенияПриИзменении(Элемент)
	
	//Если ЗначениеЗаполнено(Объект.Курс) И ЗначениеЗаполнено(Объект.Кратность) Тогда
	//	Если Объект.ИнвертироватьКурс Тогда
	//		Объект.Сумма = Объект.СуммаНазначения * Объект.Курс / Объект.Кратность;
	//	Иначе
	//		Объект.Сумма = Объект.СуммаНазначения / Объект.Курс * Объект.Кратность;;
	//	КонецЕсли;
	//КонецЕсли;	
